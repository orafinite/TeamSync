      ...
      <ul role="list" className="divide-y divide-gray-200">
        {tasks.map((task) => {
          ...
          return (
            <li
              key={task._id}
              className="p-4 flex items-center justify-between hover:bg-gray-50 transition-colors rounded-lg dark:hover:bg-zinc-800"
            >
              {/* Task Info */}
              <div className="flex flex-col space-y-1 flex-grow">
                ...
                <p className="text-md font-semibold text-gray-800 dark:text-zinc-300 truncate">
                  {task.title}
                </p>
